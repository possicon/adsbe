      ...
      html: `
        <div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.05);">
            ...
            <div style="text-align: center; padding-bottom: 20px;">
                <img src="https://res.cloudinary.com/dk1hvevsa/image/upload/v1749080731/026028d630a12ce8f94c6b206d636848a218c5e6_wqwkuv.png" alt="Trainingbe Logo" style="width: 150px; margin-bottom: 20px;" />
